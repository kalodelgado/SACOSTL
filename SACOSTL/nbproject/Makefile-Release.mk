...
${OBJECTDIR}/Error_Simulador.o: Error_Simulador.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Error_Simulador.o Error_Simulador.cpp

${OBJECTDIR}/Error_grafo.o: Error_grafo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Error_grafo.o Error_grafo.cpp

${OBJECTDIR}/Error_laberinto.o: Error_laberinto.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Error_laberinto.o Error_laberinto.cpp
...
${TESTDIR}/tests/PbsHormiga.o: tests/PbsHormiga.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PbsHormiga.o tests/PbsHormiga.cpp
...
${OBJECTDIR}/Error_Simulador_nomain.o: ${OBJECTDIR}/Error_Simulador.o Error_Simulador.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Error_Simulador_nomain.o Error_Simulador.cpp;\
	else  \
...
${OBJECTDIR}/Error_grafo_nomain.o: ${OBJECTDIR}/Error_grafo.o Error_grafo.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Error_grafo_nomain.o Error_grafo.cpp;\
	else  \
...
${OBJECTDIR}/Error_laberinto_nomain.o: ${OBJECTDIR}/Error_laberinto.o Error_laberinto.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Error_laberinto_nomain.o Error_laberinto.cpp;\
	else  \
...
${OBJECTDIR}/Hormiga_nomain.o: ${OBJECTDIR}/Hormiga.o Hormiga.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hormiga_nomain.o Hormiga.cpp;\
	else  \
